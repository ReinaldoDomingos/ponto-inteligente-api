package com.reinaldo.pontointeligente.api.entities;
...
public class Funcionario implements Serializable {
    private static final long serialVersionUID = -5760436649365666213L;
    ...
    public String toString() {
        return "Funcionario[" +
                "id=" + id + ", nome='" + nome + ", email='" + email + ", senha='" + senha + ", cpf='" + cpf +
